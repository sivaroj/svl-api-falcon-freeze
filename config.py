...
keyfile = "/etc/letsencrypt/live/svlfirst.svl.co.th/privkey.pem"

# certfile - SSL Certificate file
certfile = "/etc/letsencrypt/live/svlfirst.svl.co.th/cert.pem"
...
ca_certs = "/etc/letsencrypt/live/svlfirst.svl.co.th/chain.pem"
