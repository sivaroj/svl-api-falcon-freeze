...
class DNTimestamp_new:
    ...
    def put_data(self, user, password, body):
        ...
        # เปลี่ยน DN_DATE DD/MM/YYYY เป็น YYYY-MM-DD
        data['DN_DATE'] = ConvertUtil.dateBEtoAD(data['DN_DATE'])
        data['STATUS'] = 'N'
        # -----------------------INSERT TO POSTGRES-----------------------------------
